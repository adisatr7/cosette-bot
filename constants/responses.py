...
ROLLING: list[str] = [
    ...
    "In the realm of dice, our fate shall be decided! Rolling like true adventurers...",
    ...
    "A word of caution: be careful what you wish for when rolling the dice...",
    "The roll is about to happen... *knocks on wood* Let's hope for the best...",
    "Will it be a legendary success or a hilarious failure? Rolling now...",
]

# List of responses to say when Cosette detects a rick roll
RICK_ROLLED: list[str] = [
